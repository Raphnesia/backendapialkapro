...
use App\Filament\Resources\HisbulWathanContentResource\Pages;
...
class HisbulWathanContentResource extends Resource
{
    protected static ?string $model = HisbulWathanContent::class;

    protected static ?string $navigationIcon = 'heroicon-o-rectangle-stack';

    protected static ?string $navigationGroup = 'Profil Sekolah';

    protected static ?string $navigationLabel = 'Hisbul Wathan Konten';
        ...
        return $form
            ->schema([
                ...
                Forms\Components\RichEditor::make('content')->label('Konten')->columnSpanFull()
                    ->fileAttachmentsDirectory('hisbul-wathan/content')
    ...
    {
        return [
            'index' => Pages\ListHisbulWathanContents::route('/'),
            'create' => Pages\CreateHisbulWathanContent::route('/create'),
            'edit' => Pages\EditHisbulWathanContent::route('/{record}/edit'),
        ];
    }
} 